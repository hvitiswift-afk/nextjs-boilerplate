    ...
    <main className="min-h-screen bg-[#07070b] text-[#f5efe2]">
      <section className="mx-auto w-full max-w-7xl px-6 py-10 sm:px-10 lg:px-12">
        <nav className="flex flex-wrap items-center justify-between gap-3 border-b border-white/10 pb-5 text-sm text-white/60">
          ...
          <div className="flex flex-wrap gap-3"><a href="/service-bridge/resolve">Resolve</a><a href="/service-bridge/reconcile">Reconcile</a><a href="/service-bridge">Missions</a></div>
        </nav>
        ...
        <header className="grid gap-8 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
          <div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-white/70">Turn an approved resolution packet into a reviewed local persistence plan, then require a second exact confirmation before writing to browser storage.</p>
          </div>
          <div className="rounded-[2rem] border border-amber-300/25 bg-amber-300/[0.08] p-6">
            ...
            <p className="mt-3 text-sm leading-6 text-white/60">This page may update local browser storage only. It cannot write to third-party services or claim external completion.</p>
          </div>
        </header>
