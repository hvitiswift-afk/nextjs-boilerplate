...
export function GET() {
  return NextResponse.json({
    ...
    version: 16,
    mode: "local-first-with-orchestration-integrity-recovery-reversible-persistence-chained-lifecycle-projection-and-explicit-apply",
    missionStates,
    ...
    recovery: {
      stages: ["event-chain", "verify", "project", "reconcile", "resolve-authority", "plan-persistence", "explicit-local-write", "plan-rollback", "explicit-local-restore", "append-lifecycle-entry", "verify-lifecycle-journal", "project-lifecycle", "plan-projection-apply", "explicit-projection-commit"],
